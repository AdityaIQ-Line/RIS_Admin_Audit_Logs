import svgPaths from "./svg-uxf928b4e5";
...
function Badge2() {
  return (
    <div className="absolute bg-[#0f91b2] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[62.039px]" data-name="Badge">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#eafdfe] text-[12px] top-[2px]">Pending</p>
    </div>
  );
}
