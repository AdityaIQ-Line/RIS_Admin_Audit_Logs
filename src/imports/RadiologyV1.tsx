import svgPaths from "./svg-lvmfjdk5k5";
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[82.477px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">dd-mm-yy</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton() {
  return (
    <div className="bg-[#f3f3f5] content-stretch flex h-[36px] items-center justify-between px-[21px] py-px relative rounded-[5.2px] shrink-0 w-[137px]" data-name="Primitive.button">
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      <Icon />
      <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#737373] text-[14px]">{`Search `}</p>
    </div>
  );
}
...
function PrimitiveSpan2() {
  return (
    <div className="h-[20px] relative shrink-0 w-[82.477px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Modalities</p>
      </div>
    </div>
  );
}
...
function PrimitiveButton2() {
  return (
    <div className="bg-[#f3f3f5] flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[5.2px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[5.2px]" />
...
function PrimitiveSpan3() {
  return (
    <div className="h-[20px] relative shrink-0 w-[66.148px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Studies</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[73.906px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Priorities</p>
      </div>
    </div>
  );
}
...
function PrimitiveSpan5() {
  return (
    <div className="h-[20px] relative shrink-0 w-[73.93px]" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Status</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0" data-name="Primitive.span">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex h-full items-center overflow-clip relative rounded-[inherit]">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#0a0a0a] text-[14px] text-center">Radiologists</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[8px] items-center left-[11px] top-1/2">
      <Icon6 />
      <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#0a0a0a] text-[12px] text-center">Columns</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-white h-[36px] relative rounded-[5.2px] shrink-0 w-[93px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[5.2px]" />
      <Frame3 />
    </div>
  );
...
function TableHead1() {
  return (
    <div className="absolute h-[40px] left-[24px] top-0 w-[92.977px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">UHID</p>
    </div>
  );
}
...
function TableHead2() {
  return (
    <div className="absolute h-[40px] left-[116.98px] top-0 w-[130.258px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Patient Name</p>
    </div>
  );
}
...
function TableHead3() {
  return (
    <div className="absolute h-[40px] left-[247.23px] top-0 w-[40.922px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Age</p>
    </div>
  );
}
...
function TableHead4() {
  return (
    <div className="absolute h-[40px] left-[288.16px] top-0 w-[62.703px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Gender</p>
    </div>
  );
}
...
function TableHead5() {
  return (
    <div className="absolute h-[40px] left-[350.86px] top-0 w-[68.133px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Modality</p>
    </div>
  );
}
...
function TableHead6() {
  return (
    <div className="absolute h-[40px] left-[418.99px] top-0 w-[250px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Study Description</p>
    </div>
  );
}
...
function TableHead7() {
  return (
    <div className="absolute h-[40px] left-[668.99px] top-0 w-[158.406px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Tests</p>
    </div>
  );
}
...
function TableHead8() {
  return (
    <div className="absolute h-[40px] left-[827.4px] top-0 w-[200px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Clinical History</p>
    </div>
  );
}
...
function TableHead9() {
  return (
    <div className="absolute h-[40px] left-[1027.4px] top-0 w-[75.367px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Priority</p>
    </div>
  );
}
...
function TableHead10() {
  return (
    <div className="absolute h-[40px] left-[1102.77px] top-0 w-[121.82px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Report Status</p>
    </div>
  );
}
...
function TableHead11() {
  return (
    <div className="absolute h-[40px] left-[1224.59px] top-0 w-[132.727px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Assignment Status</p>
    </div>
  );
}
...
function TableHead12() {
  return (
    <div className="absolute h-[40px] left-[1357.31px] top-0 w-[155.703px]" data-name="TableHead">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[9.75px]">Assigned Radiologist</p>
    </div>
  );
}
...
function TableHead13() {
  return (
    <div className="absolute h-[40px] left-[1513.02px] top-0 w-[174.219px]" data-name="TableHead">
      <p className="-translate-x-full absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[166.3px] not-italic text-[#0a0a0a] text-[14px] text-right top-[9.75px]">Actions</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45678</p>
    </div>
  );
}
...
function TechnologistWorklist1() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[94.18px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Sarah Johnson</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">45Y</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="absolute h-[53px] left-[288.16px] top-0 w-[62.703px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">F</p>
    </div>
  );
}
...
function Badge() {
  return (
    <div className="absolute border border-[#e5e5e5] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[34px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#0a0a0a] text-[12px] top-[2px]">CT</p>
    </div>
  );
}
...
function TechnologistWorklist2() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">CT Chest with Contrast</p>
    </div>
  );
}
...
function TechnologistWorklist3() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-001</p>
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">Contrast Enhanced CT</p>
    </div>
  );
}
...
function TechnologistWorklist4() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0 w-[265px]">Suspected pulmonary embolism, acute chest pain</p>
    </div>
  );
}
...
function Badge1() {
  return (
    <div className="absolute bg-[#e7000b] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[46.891px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[12px] text-white top-[2px]">STAT</p>
    </div>
  );
}
...
function Badge2() {
  return (
    <div className="absolute bg-[#0f91b2] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[62.039px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#eafdfe] text-[12px] top-[2px]">Pending</p>
    </div>
  );
}
...
function Badge3() {
  return (
    <div className="absolute bg-[#f9fafb] border border-[#e5e7eb] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[81.375px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#364153] text-[12px] top-[2px]">Unassigned</p>
    </div>
  );
}
...
function TechnologistWorklist5() {
  return (
    <div className="absolute content-stretch flex h-[15.5px] items-start left-[8px] top-[18.5px] w-[4.664px]" data-name="TechnologistWorklist">
      <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#737373] text-[14px]">-</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white h-[32px] relative rounded-[5.2px] shrink-0 w-[78.094px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon7 />
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[52.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[6px]">View</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="bg-white h-[32px] relative rounded-[5.2px] shrink-0 w-[72.125px]" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Icon8 />
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[49.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-[6px]">Edit</p>
      </div>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45682</p>
    </div>
  );
}
...
function TechnologistWorklist7() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[87.133px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">James Wilson</p>
    </div>
  );
}
...
function TableCell17() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">58Y</p>
    </div>
  );
}
...
function TableCell18() {
  return (
    <div className="absolute h-[53px] left-[288.16px] top-0 w-[62.703px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">M</p>
    </div>
  );
}
...
function TechnologistWorklist8() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">CT Abdomen and Pelvis with Contrast</p>
    </div>
  );
}
...
function TechnologistWorklist9() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-005</p>
    </div>
  );
}
...
function TableCell21() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">CT Abd/Pelvis</p>
    </div>
  );
}
...
function TechnologistWorklist10() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0 w-[197px]">Abdominal pain, rule out appendicitis</p>
    </div>
  );
}
...
function Badge5() {
  return (
    <div className="absolute bg-[#df2225] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[54.023px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[12px] text-white top-[2px]">Urgent</p>
    </div>
  );
}
...
function Badge6() {
  return (
    <div className="absolute bg-[rgba(255,105,0,0.1)] border border-[#ffd6a7] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[57.352px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#ca3500] text-[12px] top-[2px]">Drafted</p>
    </div>
  );
}
...
function Badge7() {
  return (
    <div className="absolute bg-[#f0fdf4] border border-[#b9f8cf] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[67.367px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#008236] text-[12px] top-[2px]">Assigned</p>
    </div>
  );
}
...
function TechnologistWorklist11() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[139.703px]" data-name="TechnologistWorklist">
      <Icon9 />
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[16px] not-italic text-[#0a0a0a] text-[14px] top-0">Dr. Sarah Chen</p>
    </div>
  );
}
...
function TableCell29() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45683</p>
    </div>
  );
}
...
function TechnologistWorklist13() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[80.133px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Maria Garcia</p>
    </div>
  );
}
...
function TableCell31() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">72Y</p>
    </div>
  );
}
...
function Badge8() {
  return (
    <div className="absolute border border-[#e5e5e5] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[51.344px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#0a0a0a] text-[12px] top-[2px]">X-Ray</p>
    </div>
  );
}
...
function TechnologistWorklist14() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">{`Chest X-Ray PA & Lateral`}</p>
    </div>
  );
}
...
function TechnologistWorklist15() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-006</p>
    </div>
  );
}
...
function TableCell35() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">X-Ray Chest</p>
    </div>
  );
}
...
function TechnologistWorklist16() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">Routine pre-op evaluation</p>
    </div>
  );
}
...
function Badge9() {
  return (
    <div className="absolute bg-[#f4f4f5] border border-[rgba(0,0,0,0)] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[59.367px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#18181b] text-[12px] top-[2px]">Routine</p>
    </div>
  );
}
...
function TableCell43() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45684</p>
    </div>
  );
}
...
function TechnologistWorklist19() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[69.258px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">John Davis</p>
    </div>
  );
}
...
function TableCell45() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">41Y</p>
    </div>
  );
}
...
function Badge12() {
  return (
    <div className="absolute border border-[#e5e5e5] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[40px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#0a0a0a] text-[12px] top-[2px]">MRI</p>
    </div>
  );
}
...
function TechnologistWorklist20() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">MRI Lumbar Spine without Contrast</p>
    </div>
  );
}
...
function TechnologistWorklist21() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-007</p>
    </div>
  );
}
...
function TableCell49() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">MRI L-Spine</p>
    </div>
  );
}
...
function TechnologistWorklist22() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">Lower back pain, radiculopathy</p>
    </div>
  );
}
...
function Badge14() {
  return (
    <div className="absolute bg-[rgba(43,127,255,0.1)] border border-[#bedbff] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[105.82px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#1447e6] text-[12px] top-[2px]">Awaiting Review</p>
    </div>
  );
}
...
function TechnologistWorklist23() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[139.703px]" data-name="TechnologistWorklist">
      <Icon14 />
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[16px] not-italic text-[#0a0a0a] text-[14px] top-0">Dr. Michael Chen</p>
    </div>
  );
}
...
function TableCell57() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45685</p>
    </div>
  );
}
...
function Text() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Patricia Brown</p>
      </div>
    </div>
  );
}
...
function TableCell59() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">55Y</p>
    </div>
  );
}
...
function TechnologistWorklist26() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">CT Head without Contrast</p>
    </div>
  );
}
...
function TechnologistWorklist27() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-008</p>
    </div>
  );
}
...
function TableCell63() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">CT Head</p>
    </div>
  );
}
...
function TechnologistWorklist28() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0 w-[228px]">Acute stroke symptoms, onset 2 hours ago</p>
    </div>
  );
}
...
function Badge18() {
  return (
    <div className="absolute bg-[rgba(251,44,54,0.1)] border border-[#ffc9c9] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[65.367px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#c10007] text-[12px] top-[2px]">Rejected</p>
    </div>
  );
}
...
function TableCell71() {
  return (
    <div className="absolute h-[53px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45686</p>
    </div>
  );
}
...
function TechnologistWorklist31() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[113.625px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Thomas Anderson</p>
    </div>
  );
}
...
function TableCell73() {
  return (
    <div className="absolute h-[53px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">68Y</p>
    </div>
  );
}
...
function TechnologistWorklist32() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Left Knee X-Ray 2 Views</p>
    </div>
  );
}
...
function TechnologistWorklist33() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-009</p>
    </div>
  );
}
...
function TableCell77() {
  return (
    <div className="absolute h-[53px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">X-Ray Knee</p>
    </div>
  );
}
...
function TechnologistWorklist34() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">Knee pain and swelling after fall</p>
    </div>
  );
}
...
function TechnologistWorklist35() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[139.703px]" data-name="TechnologistWorklist">
      <Icon21 />
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[16px] not-italic text-[#0a0a0a] text-[14px] top-0">Dr. David Kumar</p>
    </div>
  );
}
...
function TableCell85() {
  return (
    <div className="absolute h-[52.5px] left-[24px] top-0 w-[92.977px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Consolas:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16px]">UHID-45687</p>
    </div>
  );
}
...
function TechnologistWorklist37() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[100.383px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Elizabeth Martin</p>
    </div>
  );
}
...
function TableCell87() {
  return (
    <div className="absolute h-[52.5px] left-[247.23px] top-0 w-[40.922px]" data-name="TableCell">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px] w-[25px]">34Y</p>
    </div>
  );
}
...
function TechnologistWorklist38() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[8.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">MRI Brain with Contrast</p>
    </div>
  );
}
...
function TechnologistWorklist39() {
  return (
    <div className="absolute h-[16px] left-[8px] top-[28.5px] w-[234px]" data-name="TechnologistWorklist">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0">ACC-2024-010</p>
    </div>
  );
}
...
function TableCell91() {
  return (
    <div className="absolute h-[52.5px] left-[668.99px] top-0 w-[158.406px]" data-name="TableCell">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#0a0a0a] text-[14px] top-[16.5px]">MRI Brain</p>
    </div>
  );
}
...
function TechnologistWorklist40() {
  return (
    <div className="absolute h-[16px] left-[8px] overflow-clip top-[18.5px] w-[184px]" data-name="TechnologistWorklist">
      <p className="absolute css-4hzbpn font-['Arial:Regular',sans-serif] leading-[16px] left-0 not-italic text-[#737373] text-[12px] top-0 w-[218px]">Persistent migraines, visual disturbances</p>
    </div>
  );
}
...
function Badge26() {
  return (
    <div className="absolute bg-[rgba(0,201,80,0.1)] border border-[#b9f8cf] border-solid h-[22px] left-[8px] overflow-clip rounded-[5.2px] top-[15.5px] w-[69.375px]" data-name="Badge">
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[8px] not-italic text-[#008236] text-[12px] top-[2px]">Approved</p>
    </div>
  );
}
...
function TechnologistWorklist41() {
  return (
    <div className="absolute h-[20px] left-[8px] top-[16.5px] w-[139.703px]" data-name="TechnologistWorklist">
      <Icon24 />
      <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[16px] not-italic text-[#0a0a0a] text-[14px] top-0">Dr. Emily Rodriguez</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[24px] top-[66px] w-[1303.5px]">
      <Frame2 />
...
function PageHeader() {
  return (
    <div className="absolute bg-white h-[28px] left-[24px] top-[14px] w-[144.688px]" data-name="PageHeader">
      <p className="absolute css-ew64yg font-['Arial:Bold',sans-serif] leading-[28px] left-0 not-italic text-[#0a0a0a] text-[18px] top-[0.5px]">Imaging Worklist</p>
    </div>
  );
}
...
function Link() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#737373] text-[14px] top-0">Home</p>
      </div>
    </div>
  );
}
...
function Link1() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="Link">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#737373] text-[14px] top-0">Technician</p>
      </div>
    </div>
  );
}
...
function BreadcrumbPage() {
  return (
    <div className="flex-[1_0_0] h-[20px] min-h-px min-w-px relative" data-name="BreadcrumbPage">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Worklist</p>
      </div>
    </div>
  );
}
...
function GlobalHeader1() {
  return (
    <div className="absolute h-[20px] left-[44px] overflow-clip top-[8px] w-[88.703px]" data-name="GlobalHeader">
      <p className="-translate-x-1/2 absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[44.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-0">Rajesh Kumar</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute bg-[#df2225] left-[24px] rounded-[5.2px] size-[16px] top-0" data-name="Badge">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[5px] py-[3px] relative rounded-[inherit] size-full">
        <p className="css-ew64yg font-['Arial:Regular',sans-serif] leading-[14.286px] not-italic relative shrink-0 text-[10px] text-center text-white">3</p>
      </div>
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-0" data-name="GlobalSidebar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#0a0a0a] text-[14px] top-0">Home</p>
      </div>
    </div>
  );
}
...
function GlobalSidebar1() {
  return (
    <div className="h-[20px] relative shrink-0 w-0" data-name="GlobalSidebar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#171717] text-[14px] top-0">Imaging Worklist</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[20px] left-[40.5px] not-italic text-[#0a0a0a] text-[14px] text-center top-0">David Kumar</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[16px] relative shrink-0 w-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="-translate-x-1/2 absolute css-ew64yg font-['Arial:Regular',sans-serif] leading-[16px] left-[28.5px] not-italic text-[#737373] text-[12px] text-center top-0">Technician</p>
      </div>
    </div>
  );
}
